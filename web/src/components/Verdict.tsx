      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_24rem]">
        <div className="flex flex-col justify-center gap-5 rounded-xl bg-pitch p-6 lg:p-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className={`verdict-land origin-left font-display text-6xl font-extrabold uppercase leading-none [overflow-wrap:anywhere] sm:text-7xl xl:text-8xl ${copy.tone}`}>{copy.headline}</p>
